...
const { MODEL_ENV_DETAIL_KEYS, MODEL_ENV_SHORT_KEY_MAP } = require('./model-env-keys-ui');
...
async function editModelEnvVarsMenu(apiManager, api) {
    ...
    while (true) {
        ...
        const hintFn = (idx) => {
            ...
            const detailKeys = MODEL_ENV_DETAIL_KEYS;
...
async function editModelEnvSingleField(apiManager, api, key) {
    ...
    const menu = new Menu();
    const shortKeyMap = MODEL_ENV_SHORT_KEY_MAP;
