    ...
    _saveConfigInner() {
        ...
        try {
            ...
            if (!verified.success || verified.value !== configJson) {
                ...
                // reported as saved; anything else leaves the state genuinely
                // indeterminate and the loader's backup chain is the net.
                const actual = this._readDiskState();
                if (actual === encrypted.value) {
                ...
                screen.debug('[!] Persist outcome uncertain: unverified content remains on disk');
                return false;
            }
