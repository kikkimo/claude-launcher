...
// fableModel is the provider's flagship for the Fable slot (fixed, not
// tied to the user's CUSTOM selection).
function makeFastMapTemplate(fastMap, fableModel) {
    return {
        getValues(model) {
            ...
            return {
                ...
                ANTHROPIC_DEFAULT_FABLE_MODEL: fableModel || model,
...
const providers = {
    anthropic: {
        ...
        modelEnvTemplate: {
            getValues(model) {
                ...
                const latestFable = anthropicModels.find(m => m.includes('fable')) || model;
                return {
                    ANTHROPIC_CUSTOM_MODEL_OPTION: model,
                    ANTHROPIC_CUSTOM_MODEL_OPTION_NAME: model,
                    ...
                    ANTHROPIC_DEFAULT_FABLE_MODEL: latestFable,
    ...
    moonshot: {
        ...
        versionAliases: {
            'kimi-k2.7-code': 'kimi-k3[1m]',
            'kimi-k2.6': 'kimi-k3[1m]',
            'kimi-k2.5': 'kimi-k3[1m]',
            'kimi-k2-thinking': 'kimi-k3[1m]',
            'kimi-k2-thinking-turbo': 'kimi-k3[1m]',
            'kimi-k2-0711-preview': 'kimi-k3[1m]',
            'kimi-k2-0905-preview': 'kimi-k3[1m]',
            'kimi-k2-turbo-preview': 'kimi-k3[1m]',
        },
        authTokenFormat: 'sk-...',
    ...
    minimax_cn: {
        ...
        envVars: {
            ...
            CLAUDE_CODE_DISABLE_NONSTREAMING_FALLBACK: '1'
                ...
                modelEnvTemplate: makeFastMapTemplate({"MiniMax-M2.7":"MiniMax-M2.7-highspeed","MiniMax-M2.5":"MiniMax-M2.5-highspeed","MiniMax-M2.1":"MiniMax-M2.1-highspeed"}, 'MiniMax-M3'),
        note: 'Requires extended timeout for large responses'
    },
    minimax_global: {
    ...
    deepseek: {
        ...
        modelEnvTemplate: makeFastMapTemplate({"deepseek-v4-pro[1m]":"deepseek-v4-flash"}, 'deepseek-v4-pro[1m]'),
        note: 'Requires extended timeout for complex reasoning tasks',
    },
    zhipu: {
        name: 'ZhiPu AI (GLM-5.3/5-Turbo) - 智谱清言',
    ...
    zai: {
        name: 'Z.ai (GLM-5.3/5-Turbo) - ZhiPu Global',
