...
module.exports = {
    ...
    warnings: {
        ...
        snapshot_unreadable: "移行前のスナップショットがディスクにありますが、現在の鍵では開けません: {0}\n**削除しないでください** — 別のネットワークに移ったり、鍵マテリアルファイルを復元したりすると再び読めるようになる場合があります。",
    ...
    import_export: {
        export: {
            ...
            details_skipped: "除外（保存されたトークンを復号できませんでした）: {0}",
