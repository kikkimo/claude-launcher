...
module.exports = {
    ...
    warnings: {
        ...
        snapshot_unreadable: "Un instantané antérieur à la migration est sur le disque mais la clé actuelle ne peut pas l'ouvrir : {0}\nNe le supprimez PAS — il peut redevenir lisible sur un autre réseau ou après restauration du fichier de matériel de clé.",
    ...
    import_export: {
        export: {
            ...
            details_skipped: "Ignorées (leur jeton stocké n'a pas pu être déchiffré) : {0}",
