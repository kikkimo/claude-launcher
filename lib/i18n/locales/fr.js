...
module.exports = {
    ...
    // Types de messages
    warnings: {
        config_load_error: "Le fichier de configuration API est illisible et n'a PAS été écrasé : {0}\nRestaurez le fichier manuellement ou supprimez-le pour repartir de zéro.",
