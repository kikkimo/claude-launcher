...
module.exports = {
    ...
    warnings: {
        ...
        snapshot_available: "Sul disco è ancora presente e leggibile un'istantanea di una configurazione precedente alla migrazione: {0}\nNon viene mai usata automaticamente. Vedi la sezione sui backup del README per ripristinarla.",
        snapshot_unreadable: "Sul disco c'è un'istantanea precedente alla migrazione che la chiave attuale non riesce ad aprire: {0}\nNON eliminarla: può tornare leggibile su un'altra rete o dopo aver ripristinato il file del materiale della chiave.",
    ...
    import_export: {
        export: {
            ...
            details_skipped: "Escluse (il token memorizzato non è stato decifrato): {0}",
