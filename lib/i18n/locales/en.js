...
module.exports = {
    ...
    menu: {
        ...
        api_management: {
            ...
            quarantine_config: "Set the unreadable config aside and start fresh",
            restore_quarantined: "Restore a set-aside config",
    ...
    // Message types
    warnings: {
        config_load_error: "API config file is unreadable and was NOT overwritten: {0}\nOpen 3rd-party API Management to set it aside safely (nothing is deleted) and start fresh.",
        config_recovered: "API config file was corrupted — recovered automatically from backup: {0}",
        superseded_preserved: "The generation it replaced was NOT deleted — it is kept at {0}.",
        snapshot_available: "A pre-migration snapshot of an earlier config is still on disk and can be read: {0}\nIt is never used automatically. See the Backing up section of the README to restore from it.",
        snapshot_unreadable: "A pre-migration snapshot is on disk but the current key cannot open it: {0}\nDo NOT delete it — it may become readable again on another network, or once the key material file is restored.",
        quarantine_available: "A previously set-aside config is still on disk. Try \"Restore a set-aside config\" in 3rd-party API Management.",
        token_unrecoverable: "The auth token of these APIs could not be decrypted: {0}\nRe-enter them. The earlier ciphertext is kept at {1} and nothing was deleted.",
        key_material_degraded: "Machine key material: {0}",
        config_unreadable_key_material: "The machine key material is unreadable, so nothing can be decrypted: {0}\nYour API config file is most likely INTACT — do not delete it. Repair or remove the key material file instead; on this machine the identity can normally be re-derived.\nDetails: {1}",
    },

    quarantine: {
        cancelled: "Cancelled — nothing was changed.",
        confirm: "Set aside {0} and start with an empty config?\nThe files are only RENAMED (to *.unreadable.N) — nothing is deleted, and you can restore them later.",
        done: "Set aside as *.unreadable.{0} ({1} file(s)). Nothing was deleted.",
        entry_readable: "#{0} — readable now, {1} API(s): {2}",
        entry_unreadable: "#{0} — still unreadable on this machine",
        failed: "Could not set the config aside ({0}). Nothing was changed.",
        restore_confirm: "Restore set-aside config #{0}? The config in use right now is kept as a backup generation.",
        restore_done: "Restored set-aside config #{0} ({1} API(s)).",
        restore_failed: "Could not restore ({0}). Nothing was changed.",
        restore_none: "No set-aside config can be opened on this machine right now.",
        restore_title: "Set-aside configs",
    },
    ...
    errors: {
        ...
        validation: {
            ...
            auth_token_placeholder: "That is a placeholder an export writes when a token is missing, not a token",
    ...
    import_export: {
        export: {
            ...
            details_skipped: "Left out (their stored token could not be decrypted): {0}",
    ...
    version: {
        ...
        install_command: "Run npm install -g @kikkimo/claude-launcher@latest to update",
    ...
    version_check: {
        ...
        update_command: "Update command: npm install -g @kikkimo/claude-launcher@latest",
