...
module.exports = {
    ...
    // Nachrichtentypen
    warnings: {
        config_load_error: "API-Konfigurationsdatei ist unlesbar und wurde NICHT überschrieben: {0}\nStelle die Datei manuell wieder her oder lösche sie, um neu zu beginnen.",
