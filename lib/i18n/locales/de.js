...
module.exports = {
    ...
    menu: {
        ...
        api_management: {
            ...
            quarantine_config: "Unlesbare Konfiguration beiseitelegen und neu beginnen",
            restore_quarantined: "Beiseitegelegte Konfiguration wiederherstellen",
    ...
    // Nachrichtentypen
    warnings: {
        config_load_error: "Die API-Konfigurationsdatei ist unlesbar und wurde NICHT überschrieben: {0}\nÖffnen Sie die Drittanbieter-API-Verwaltung, um sie sicher beiseitezulegen (nichts wird gelöscht) und neu zu beginnen.",
        config_recovered: "API-Konfigurationsdatei war beschädigt — automatisch aus dem Backup wiederhergestellt: {0}",
        superseded_preserved: "Die ersetzte Generation wurde NICHT gelöscht — sie liegt unter {0}.",
        snapshot_available: "Ein Snapshot einer früheren Konfiguration von vor der Migration liegt noch lesbar auf der Festplatte: {0}\nEr wird nie automatisch verwendet. Zum Wiederherstellen siehe den Abschnitt zur Sicherung in der README.",
        snapshot_unreadable: "Ein Snapshot von vor der Migration liegt auf der Festplatte, lässt sich mit dem aktuellen Schlüssel aber nicht öffnen: {0}\nLöschen Sie ihn NICHT — in einem anderen Netzwerk oder nach dem Wiederherstellen der Schlüsselmaterialdatei kann er wieder lesbar werden.",
        quarantine_available: "Eine zuvor beiseitegelegte Konfiguration liegt noch auf der Festplatte. Versuchen Sie „Beiseitegelegte Konfiguration wiederherstellen“ in der Drittanbieter-API-Verwaltung.",
        token_unrecoverable: "Das Auth-Token dieser APIs konnte nicht entschlüsselt werden: {0}\nBitte erneut eingeben. Der frühere Chiffretext bleibt unter {1} erhalten, es wurde nichts gelöscht.",
        key_material_degraded: "Maschinen-Schlüsselmaterial: {0}",
        config_unreadable_key_material: "Das Maschinen-Schlüsselmaterial ist unlesbar, daher kann nichts entschlüsselt werden: {0}\nIhre API-Konfigurationsdatei ist höchstwahrscheinlich INTAKT — löschen Sie sie nicht. Reparieren oder entfernen Sie stattdessen die Schlüsselmaterialdatei; auf diesem Rechner lässt sich die Identität normalerweise neu ableiten.\nDetails: {1}",
    },

    quarantine: {
        cancelled: "Abgebrochen — es wurde nichts geändert.",
        confirm: "{0} beiseitelegen und mit einer leeren Konfiguration beginnen?\nDie Dateien werden nur UMBENANNT (zu *.unreadable.N) — nichts wird gelöscht, und Sie können sie später wiederherstellen.",
        done: "Als *.unreadable.{0} beiseitegelegt ({1} Datei(en)). Es wurde nichts gelöscht.",
        entry_readable: "#{0} — jetzt lesbar, {1} API(s): {2}",
        entry_unreadable: "#{0} — auf diesem Rechner weiterhin unlesbar",
        failed: "Die Konfiguration konnte nicht beiseitegelegt werden ({0}). Es wurde nichts geändert.",
        restore_confirm: "Beiseitegelegte Konfiguration #{0} wiederherstellen? Die aktuell genutzte Konfiguration bleibt als Sicherungsgeneration erhalten.",
        restore_done: "Beiseitegelegte Konfiguration #{0} wiederhergestellt ({1} API(s)).",
        restore_failed: "Wiederherstellung fehlgeschlagen ({0}). Es wurde nichts geändert.",
        restore_none: "Auf diesem Rechner lässt sich derzeit keine beiseitegelegte Konfiguration öffnen.",
        restore_title: "Beiseitegelegte Konfigurationen",
    },
    ...
    errors: {
        ...
        validation: {
            ...
            auth_token_placeholder: "Das ist ein Platzhalter, den ein Export bei fehlendem Token schreibt, kein Token",
    ...
    import_export: {
        export: {
            ...
            details_skipped: "Ausgelassen (das gespeicherte Token konnte nicht entschlüsselt werden): {0}",
    ...
    version: {
        ...
        install_command: "Führen Sie npm install -g @kikkimo/claude-launcher@latest aus, um zu aktualisieren",
    ...
    version_check: {
        ...
        update_command: "Update-Befehl: npm install -g @kikkimo/claude-launcher@latest",
    ...
    hints: {
        ...
        model: {
            ...
            fable: "Entspricht der Claude-Code-Fable-Stufe",
            fable_detail: "Flaggschiffmodell für langfristige und Hintergrundaufgaben. Entsprechend der Umgebungsvariable [ANTHROPIC_DEFAULT_FABLE_MODEL]. Automatisch dem Flaggschiff des Anbieters zugeordnet",
    ...
    config_labels: {
        model: {
            ...
            ANTHROPIC_DEFAULT_FABLE_MODEL: "Fable-Modell (Fable)",
