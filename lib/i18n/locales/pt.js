...
module.exports = {
    ...
    // Message types
    warnings: {
        config_load_error: "O arquivo de configuração da API está ilegível e NÃO foi sobrescrito: {0}\nRestaure o arquivo manualmente ou exclua-o para começar do zero.",
