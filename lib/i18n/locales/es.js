...
module.exports = {
    ...
    menu: {
        ...
        api_management: {
            ...
            quarantine_config: "Apartar la configuración ilegible y empezar de nuevo",
            restore_quarantined: "Restaurar una configuración apartada",
    ...
    // Tipos de mensajes
    warnings: {
        config_load_error: "El archivo de configuración de API es ilegible y NO se sobrescribió: {0}\nAbra la gestión de API de terceros para apartarlo de forma segura (no se elimina nada) y empezar de nuevo.",
        ...
        superseded_preserved: "La generación reemplazada NO se eliminó: se conserva en {0}.",
        snapshot_available: "Todavía hay en el disco una instantánea legible de una configuración anterior a la migración: {0}\nNunca se usa automáticamente. Consulte la sección de copias de seguridad del README para restaurarla.",
        snapshot_unreadable: "Hay en el disco una instantánea anterior a la migración que la clave actual no puede abrir: {0}\nNO la elimine: puede volver a ser legible en otra red o al restaurar el archivo de material de clave.",
        quarantine_available: "Una configuración apartada anteriormente sigue en el disco. Pruebe «Restaurar una configuración apartada» en la gestión de API de terceros.",
        token_unrecoverable: "No se pudo descifrar el token de autenticación de estas API: {0}\nVuelva a introducirlos. El texto cifrado anterior se conserva en {1} y no se eliminó nada.",
        key_material_degraded: "Material de clave de la máquina: {0}",
        config_unreadable_key_material: "El material de clave de la máquina es ilegible, así que no se puede descifrar nada: {0}\nSu archivo de configuración de API está casi con seguridad INTACTO: no lo elimine. Repare o quite el archivo de material de clave; en esta máquina la identidad suele poder volver a derivarse.\nDetalles: {1}",
    },

    quarantine: {
        cancelled: "Cancelado: no se cambió nada.",
        confirm: "¿Apartar {0} y empezar con una configuración vacía?\nLos archivos solo se RENOMBRAN (a *.unreadable.N): no se elimina nada y podrá restaurarlos más tarde.",
        done: "Apartado como *.unreadable.{0} ({1} archivo(s)). No se eliminó nada.",
        entry_readable: "#{0} — legible ahora, {1} API: {2}",
        entry_unreadable: "#{0} — sigue siendo ilegible en esta máquina",
        failed: "No se pudo apartar la configuración ({0}). No se cambió nada.",
        restore_confirm: "¿Restaurar la configuración apartada #{0}? La configuración en uso se conserva como generación de copia de seguridad.",
        restore_done: "Configuración apartada #{0} restaurada ({1} API).",
        restore_failed: "No se pudo restaurar ({0}). No se cambió nada.",
        restore_none: "Ahora mismo no se puede abrir ninguna configuración apartada en esta máquina.",
        restore_title: "Configuraciones apartadas",
    },
    ...
    errors: {
        ...
        validation: {
            ...
            auth_token_placeholder: "Eso es un marcador de posición que escribe la exportación cuando falta el token, no un token",
    ...
    import_export: {
        export: {
            ...
            details_skipped: "Omitidas (no se pudo descifrar su token almacenado): {0}",
