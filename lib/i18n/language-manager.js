        ...
        try {
            ...
            if (fs.existsSync(this.configFile)) {
                try {
                    ...
                    // Corrupt file: do not risk clobbering it with a fresh
                    // config — leave it untouched for manual recovery.
                    screen.debug('Config file is corrupt; leaving it untouched (language preference not saved)');
                    return;
                }
            }
